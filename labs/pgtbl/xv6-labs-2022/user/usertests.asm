...
0000000000001392 <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    142a:	13a78793          	addi	a5,a5,314 # 9560 <big.1274>
    142e:	00009697          	auipc	a3,0x9
    1432:	13268693          	addi	a3,a3,306 # a560 <big.1274+0x1000>
      big[i] = 'x';
    ...
    1448:	10078e23          	sb	zero,284(a5) # a560 <big.1274+0x1000>
...
00000000000022cc <bigargtest>:
{
  ...
  close(fd);
    ...
    2334:	13078793          	addi	a5,a5,304 # 9460 <args.1822>
    2338:	00007697          	auipc	a3,0x7
    233c:	22068693          	addi	a3,a3,544 # 9558 <args.1822+0xf8>
    ...
    2354:	11058593          	addi	a1,a1,272 # 9460 <args.1822>
